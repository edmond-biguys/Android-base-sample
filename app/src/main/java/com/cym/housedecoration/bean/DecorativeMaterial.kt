...
data class DecorativeMaterial(
    ...
    var payedPrice: BigDecimal = 0.0.toBigDecimal(), //已支付的金额
        ...
        fun mockData(): List<DecorativeMaterial> {
            ...
            list.add(
                DecorativeMaterial(
                    ...
                    unitPrice = 800.00.toBigDecimal(), payedPrice = 36000.0.toBigDecimal(), totalPrice = 48240.0.toBigDecimal(),
            ...
            list.add(
                DecorativeMaterial(
                    ...
                    unitPrice = 1200.00.toBigDecimal(), payedPrice = 0.0.toBigDecimal(), totalPrice = 4200.0.toBigDecimal(),
            ...
            list.add(
                DecorativeMaterial(
                    ...
                    unitPrice = 450.00.toBigDecimal(), payedPrice = 0.0.toBigDecimal(), totalPrice = 2250.0.toBigDecimal(),
            ...
            list.add(
                DecorativeMaterial(
                    ...
                    unitPrice = 0.0.toBigDecimal(), payedPrice = 30000.0.toBigDecimal(), totalPrice = 50000.0.toBigDecimal(),
            ...
            list.add(
                DecorativeMaterial(
                    ...
                    unitPrice = 1500.00.toBigDecimal(), payedPrice = 5000.0.toBigDecimal(), totalPrice = 15600.0.toBigDecimal(),
